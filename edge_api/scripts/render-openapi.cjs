...
const spec = {
  ...
  components: {
    ...
    schemas: {
      ...
      LogQueryFilter: { type: 'object', properties: { query: str, from: dt, to: dt, agent_id: str, host: str, service: str, severity: str } },
      LogSearchRequest: { type: 'object', properties: { query: str, from: dt, to: dt, agent_id: str, host: str, service: str, severity: str, limit: u32, offset: u64 } },
