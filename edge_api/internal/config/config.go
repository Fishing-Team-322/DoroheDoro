	...
	cfg := Config{
		...
		NATS: NATSConfig{
			...
			Subjects: subjects.Registry{
				...
				ControlIntegrationsList:       envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_LIST", "SUBJECT_INTEGRATIONS_LIST"}, defaultSubjects.ControlIntegrationsList),
				ControlIntegrationsGet:        envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_GET", "SUBJECT_INTEGRATIONS_GET"}, defaultSubjects.ControlIntegrationsGet),
				ControlIntegrationsCreate:     envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_CREATE", "SUBJECT_INTEGRATIONS_CREATE"}, defaultSubjects.ControlIntegrationsCreate),
				ControlIntegrationsUpdate:     envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_UPDATE", "SUBJECT_INTEGRATIONS_UPDATE"}, defaultSubjects.ControlIntegrationsUpdate),
				ControlIntegrationsBind:       envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_BIND", "SUBJECT_INTEGRATIONS_BIND"}, defaultSubjects.ControlIntegrationsBind),
				ControlIntegrationsUnbind:     envAny([]string{"SUBJECT_CONTROL_INTEGRATIONS_UNBIND", "SUBJECT_INTEGRATIONS_UNBIND"}, defaultSubjects.ControlIntegrationsUnbind),
				...
				AnomalyRulesList:              envAny([]string{"SUBJECT_ANOMALIES_RULES_LIST", "SUBJECT_ANOMALY_RULES_LIST"}, defaultSubjects.AnomalyRulesList),
				AnomalyRulesGet:               envAny([]string{"SUBJECT_ANOMALIES_RULES_GET", "SUBJECT_ANOMALY_RULES_GET"}, defaultSubjects.AnomalyRulesGet),
				AnomalyRulesCreate:            envAny([]string{"SUBJECT_ANOMALIES_RULES_CREATE", "SUBJECT_ANOMALY_RULES_CREATE"}, defaultSubjects.AnomalyRulesCreate),
				AnomalyRulesUpdate:            envAny([]string{"SUBJECT_ANOMALIES_RULES_UPDATE", "SUBJECT_ANOMALY_RULES_UPDATE"}, defaultSubjects.AnomalyRulesUpdate),
				AnomalyInstancesList:          envAny([]string{"SUBJECT_ANOMALIES_INSTANCES_LIST", "SUBJECT_ANOMALY_INSTANCES_LIST"}, defaultSubjects.AnomalyInstancesList),
				AnomalyInstancesGet:           envAny([]string{"SUBJECT_ANOMALIES_INSTANCES_GET", "SUBJECT_ANOMALY_INSTANCES_GET"}, defaultSubjects.AnomalyInstancesGet),
