	...
	cfg := Config{
		...
		NATS: NATSConfig{
			...
			Subjects: subjects.Registry{
				...
				NotificationsDispatchRequested:          env("SUBJECT_NOTIFICATIONS_DISPATCH_REQUESTED", defaultSubjects.NotificationsDispatchRequested),
				NotificationsTelegramDispatchRequested:  env("SUBJECT_NOTIFICATIONS_TELEGRAM_DISPATCH_REQUESTED", defaultSubjects.NotificationsTelegramDispatchRequested),
				NotificationsTelegramDispatchSucceeded:  env("SUBJECT_NOTIFICATIONS_TELEGRAM_DISPATCH_SUCCEEDED", defaultSubjects.NotificationsTelegramDispatchSucceeded),
				NotificationsTelegramDispatchFailed:     env("SUBJECT_NOTIFICATIONS_TELEGRAM_DISPATCH_FAILED", defaultSubjects.NotificationsTelegramDispatchFailed),
				NotificationsTelegramHealthcheckRequest: env("SUBJECT_NOTIFICATIONS_TELEGRAM_HEALTHCHECK_REQUESTED", defaultSubjects.NotificationsTelegramHealthcheckRequest),
				NotificationsTelegramHealthcheckResult:  env("SUBJECT_NOTIFICATIONS_TELEGRAM_HEALTHCHECK_RESULT", defaultSubjects.NotificationsTelegramHealthcheckResult),
